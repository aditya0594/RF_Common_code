...
import Examination.AL_Examination_COE_BundleCreation4;
import pojo.Browser;
...
public class AL_Examination_COE_BundleCreationTest4 extends BaseClass {

	ExtentReports reports;
	ExtentTest test;
	HomePageAdmin homePageAdmin;
	AL_Examination_COE_BundleCreation4 al_Examination_COE_BundleCreation;
	...
	@Test
	public void aL_Examination_COE_BundleCreationTest4() throws InterruptedException, IOException, AWTException {

		homePageAdmin = new HomePageAdmin(driver);
		al_Examination_COE_BundleCreation = new AL_Examination_COE_BundleCreation4(driver);
		...
		Thread.sleep(3000);
		// Click Acknowledgement Receipt Button
		al_Examination_COE_BundleCreation.click_AcknowledgementReport_Button();
		Thread.sleep(3000);
		...
		Thread.sleep(5000);
		pdfutility.downloadPDF(driver, "Exam - Bundle Creation - Acknowledgement Report");
		Thread.sleep(5000);
		pdfutility.readPDF("Exam - Bundle Creation - Acknowledgement Report", "Theory");
