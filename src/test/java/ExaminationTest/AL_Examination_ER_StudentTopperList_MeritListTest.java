...
import Examination.AL_Examination_ER_StudentTopperList_MeritList;
...
public class AL_Examination_ER_StudentTopperList_MeritListTest extends BaseClass
{
	ExtentReports reports;
	ExtentTest test;
	AL_Examination_ER_StudentTopperList_MeritList stu_top_list;
	HomePageAdmin HP;
	...
	@Test
	public void aL_Examination_ER_StudentTopperList_MeritList() throws InterruptedException, IOException {
		
	System.out.println("Examination==>Examination Reports==> Exam Report=>Student Topper List==>Topper list report");
		
		stu_top_list = new AL_Examination_ER_StudentTopperList_MeritList(driver);
		test = reports.createTest("aL_Examination_ER_StudentTopperList_MeritList");
		...
		Thread.sleep(5000);;
		stu_top_list.Click_MeritListRadioBtn();
		...
		captureScreenshot(driver, "Student Topper List Merit List report");
