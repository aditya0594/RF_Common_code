...
import Examination.AL_Examination_COE_BundleCreation;
import pojo.Browser;
...
public class AL_Examination_COE_BundleCreationTest extends BaseClass {

	ExtentReports reports;
	ExtentTest test;
	HomePageAdmin homePageAdmin;
	AL_Examination_COE_BundleCreation al_Examination_COE_BundleCreation;
	...
	@Test
	public void aL_Examination_COE_BundleCreationTest() throws InterruptedException, IOException, AWTException {

		homePageAdmin = new HomePageAdmin(driver);
		al_Examination_COE_BundleCreation = new AL_Examination_COE_BundleCreation(driver);
		...
		String Expected_Msg = "Bundle Already Created..!!";
		...
		Thread.sleep(2000); 
		// Click Datawise Bundle List Button
		al_Examination_COE_BundleCreation.click_DataWiseBundleList_Button();
		Thread.sleep(2000);
		...
		Thread.sleep(5000);
		pdfutility.downloadPDF(driver, "Exam - Bundle Creation - Datewise bundle list");
		Thread.sleep(5000);
		pdfutility.readPDF("Exam - Bundle Creation - Datewise bundle list", "ARC");	
