...
public class SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 extends BaseClass {

    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10(WebDriver rdriver) {
        driver = rdriver;
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 loginPage() throws InterruptedException {
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 clickStudentInformation() {
        System.out.println("Click on Student Information");
        studentInformation.click();
        return this;
    }

    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 clickStudentRelated() {
        System.out.println("Click on Student Related");
        studentRelated.click();
        return this;
    }

    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Click_QualificationDetailsTab() {
        System.out.println("Click on Qualification DetailsTab");
        qualificationdetailstab.click();
        return this;
    }

    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Enter_Schoolname10th() {
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Enter_Board10th() {
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Enter_YearOfExam10th() {
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 OutOfMArks() {
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 MarksObtain() {
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Enter_OutOfMarks10th() throws InterruptedException {
...
//        outofmarks10th.sendKeys("700");
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Enter_MarkObtain10th() {
...
//        marksobtaine10th.sendKeys("450");
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Enter_SchoolName12th() {
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Enter_Board12th() {
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Enter_YearOfExam12th() {
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Enter_TotalMarks12th() {
...
//        totalmarks12th.sendKeys("700");
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Enter_MarkObtained12th() {
...
//        obtainedmarks12th.sendKeys("500");
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Enter_EntranceExamName() {
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Enter_SeatNo() {
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Enter_YearOfExam() {
        String num = "2011";
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Enter_Percentage() {
        String num = "69";
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Enter_TotalMarks() {
        String num = "200";
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Enter_EntranceObtainedMarks() {
        String num = "130";
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Enter_Rank() {
        String num = "111";
        entrancerank.clear();
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Enter_CategoryRank() {
        String num = "74";
        categoryrank.clear();
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Click_EntranceAddBtn() {
        addbtn.click();
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Enter_SchoolCollegePG() {
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Enter_BoardPG() {
        String num = "Nagpur";
        boardPG.clear();
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Enter_QualifyingExamPG() {
        String examname = "HG";
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Enter_SeatNoPG() {
        String num = "RF 12345";
        seatnoPG.clear();
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Enter_YearofExamPG() {
        String num = "2015";
        yearofexamPG.clear();
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Enter_StatusPG() {
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Enter_OutOfMarksPG() {
        String num = "600";
        outofmarksPG.clear();
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Enter_MarksObtainedPG() {
        String num = "430";
        markobtainPG.clear();
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Enter_GradePG() {
        String num = "A";
        gradePG.clear();
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Enter_DGPACGPA_PG() {
        String num = "7.5";
        dgpacgpaPG.clear();
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Enter_SchoolCollegeAddressPG() {
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Click_AddBtn_PG() {
        addbtnPG.click();
        System.out.println("Click_AddBtn_PG");
        return this;
    }

    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Click_SaveContinueQualificationDetails() throws InterruptedException {
...
//		alert.accept();
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Click_Vaccinated_No() {
        vaccination_No.click();
        System.out.println("Click_Vaccinated_No");
        return this;
    }

    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Click_Vaccinated_Yes() {
        vaccination_yes.click();
        System.out.println("Click_Vaccinated_Yes");
        return this;
    }

    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Click_SaveContinueCovidInformation() {
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Enter_BankName() {
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Enter_BankAccountNo() {
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Enter_BranchName() {
        String num = "Dhantoli";
        branchname.clear();
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Enter_IFSCode() {
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Enter_BankAddress() {
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 I_AgreeCheckBox() {
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 sportName() throws InterruptedException {
        Thread.sleep(1000);
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 sportLevel() throws InterruptedException {
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 sportAddButton() {
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 sportAchivement() {
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 Click_SaveBtn() throws InterruptedException {
        Thread.sleep(2000);
    ...
    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 enterQualificationDetails(String qualification) {
        // Add logic to enter qualification details
        System.out.println("Entered qualification: " + qualification);
        return this;
    }

    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 submitForm() {
        // Add logic to submit the form
        System.out.println("Form submitted");
        return this;
    }

    public SL_Academic_SR_QualificationDetails_StudentFlow_Flow_10 resetForm() {
