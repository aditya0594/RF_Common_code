...
public class SL_Academic_SR_DocumentUpload_StudentFlow_Flow_09 extends BaseClass {
    public SL_Academic_SR_DocumentUpload_StudentFlow_Flow_09(WebDriver rdriver) {
        driver = rdriver;
    ...
    public SL_Academic_SR_DocumentUpload_StudentFlow_Flow_09 loginPage() throws InterruptedException {
    ...
    public SL_Academic_SR_DocumentUpload_StudentFlow_Flow_09 uploadDoucumentNext() throws InterruptedException {
    ...
    public SL_Academic_SR_DocumentUpload_StudentFlow_Flow_09 clickStudentRelated() {
    ...
    public SL_Academic_SR_DocumentUpload_StudentFlow_Flow_09 clickStudentInformation() {
        System.out.println("Click on Student Information");
        studentInformation.click();
        return this;
    }

    public SL_Academic_SR_DocumentUpload_StudentFlow_Flow_09 Enter_MobileNo() {
    ...
    public SL_Academic_SR_DocumentUpload_StudentFlow_Flow_09 Enter_BirthPlace() {
    ...
    public SL_Academic_SR_DocumentUpload_StudentFlow_Flow_09 Select_Nationality() {
    ...
    public SL_Academic_SR_DocumentUpload_StudentFlow_Flow_09 Select_Religion() {
        String branch = "Islam";
    ...
    public SL_Academic_SR_DocumentUpload_StudentFlow_Flow_09 Enter_AdharCard() {
    ...
    public SL_Academic_SR_DocumentUpload_StudentFlow_Flow_09 Enter_ABC_ID() {
    ...
    public SL_Academic_SR_DocumentUpload_StudentFlow_Flow_09 Upload_Photo() throws InterruptedException {
    ...
    public SL_Academic_SR_DocumentUpload_StudentFlow_Flow_09 Click_SaveContinueBtn() {
    ...
    public SL_Academic_SR_DocumentUpload_StudentFlow_Flow_09 Click_AddressDetails() {
        System.out.println("Click on Address Details");
    ...
    public SL_Academic_SR_DocumentUpload_StudentFlow_Flow_09 Enter_Country() {
    ...
    public SL_Academic_SR_DocumentUpload_StudentFlow_Flow_09 Enter_State() {
    ...
    public SL_Academic_SR_DocumentUpload_StudentFlow_Flow_09 Enter_District() {
    ...
    public SL_Academic_SR_DocumentUpload_StudentFlow_Flow_09 Enter_City() {
        String criteria = "Pune";
    ...
    public SL_Academic_SR_DocumentUpload_StudentFlow_Flow_09 Enter_PinCode() {
    ...
    public SL_Academic_SR_DocumentUpload_StudentFlow_Flow_09 Upload_10th_Marksheet() throws InterruptedException {
    ...
    public SL_Academic_SR_DocumentUpload_StudentFlow_Flow_09 Upload_12th_Marksheet() throws InterruptedException {
    ...
    public SL_Academic_SR_DocumentUpload_StudentFlow_Flow_09 Upload_AdharCard() throws InterruptedException {
    ...
    public SL_Academic_SR_DocumentUpload_StudentFlow_Flow_09 Upload_Addressparticulars() throws InterruptedException {
    ...
    public SL_Academic_SR_DocumentUpload_StudentFlow_Flow_09 Upload_CandidateMedicalRecord() throws InterruptedException {
    ...
    public SL_Academic_SR_DocumentUpload_StudentFlow_Flow_09 Upload_CommunityCertificate() throws InterruptedException {
    ...
    public SL_Academic_SR_DocumentUpload_StudentFlow_Flow_09 Upload_ConductCertificate() throws InterruptedException {
    ...
    public SL_Academic_SR_DocumentUpload_StudentFlow_Flow_09 Upload_JointDeclaration() throws InterruptedException {
    ...
    public SL_Academic_SR_DocumentUpload_StudentFlow_Flow_09 Upload_JointUndertakingHindi() throws InterruptedException {
    ...
    public SL_Academic_SR_DocumentUpload_StudentFlow_Flow_09 Upload_JointUndertakingTamil() throws InterruptedException {
    ...
    public SL_Academic_SR_DocumentUpload_StudentFlow_Flow_09 Upload_Otherdocuments() throws InterruptedException {
    ...
    public SL_Academic_SR_DocumentUpload_StudentFlow_Flow_09 Upload_Photograph() throws InterruptedException {
    ...
    public SL_Academic_SR_DocumentUpload_StudentFlow_Flow_09 Upload_Profileofthestudent() throws InterruptedException {
    ...
    public SL_Academic_SR_DocumentUpload_StudentFlow_Flow_09 Upload_TransferCertificate() throws InterruptedException {
    ...
    public SL_Academic_SR_DocumentUpload_StudentFlow_Flow_09 Click_NextContinueBtn() {
        System.out.println("Click_NextContinueBtn");
        nextContinue.click();
        return this;
    }

    public SL_Academic_SR_DocumentUpload_StudentFlow_Flow_09 exampleMethod() {
        // Add your logic here
        return this;
    }
