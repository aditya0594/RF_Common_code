...
public class AL_Administration_FM_Rpt_SR_ERPAMCProppsalReportTest extends BaseClass   {
	...
	@Test
	public void aL_Administration_FM_Rpt_SR_ERPAMCProppsalReportTest() throws Exception {
		...
		System.out.println("Administration->File Movement-> Reports -> Status Report --> ERP AMC Proppsal Report");
