...
//		driver.get("https://rfcautomationuat.mastersofterp.in/academic/iitmsJYBHWhGToc6CXeqRuLRcRcI0iIwVkodNKbJrxkAgFuQag0TRiq4GrNmxCk0bSXMubIjOYGD/syPbQCGJipLZJA==?enc=M1EsHDAeRhaekcwzmtddkotanzDJcibQFrURMECwGng=");
...
//
//		Thread.sleep(2000);
//		WebElement semester = driver.findElement(By.id("select2-ctl00_ContentPlaceHolder1_ddlSemester-container"));
//		semester.click();
