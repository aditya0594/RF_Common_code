...
public class StudentRelated_CourseRegistration extends BaseClass{
	...
	@Test
	public void Student_CourseRegistration() throws Exception 
	{
		test=reports.createTest("Student_CourseRegistration");
		Thread.sleep(2000);
...
//		System.out.println("Alert Text is:" + s);
		...
		WebElement opt = driver.findElement(By.id("ctl00_repLinks_ctl08_lbLink"));
		opt.click();
		System.out.println("Click Course Registration");
		Thread.sleep(2000);
		...
		//Note:Unable to proceed further due to payment not done
	}
