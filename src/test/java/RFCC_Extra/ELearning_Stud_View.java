...
public class ELearning_Stud_View extends BaseClass{
	...
	@Test
	public void eLearning_Stud_View() throws Throwable
	{
		test = reports.createTest("Student_ELearning_ViewAssignment");
		...
		Thread.sleep(2000);
		WebElement viewassgn = driver.findElement(By.linkText("View Student Assignment"));
		Actions ac2 = new Actions(driver);
		ac2.moveToElement(viewassgn).click().perform();
		System.out.println(" View Student Assignment submenu selected");
		
		Thread.sleep(2000);
		driver.findElement(By.id("ctl00_ContentPlaceHolder1_lvAssignment_ctrl0_btnEdit")).click();
		...
		driver.findElement(By.className("cke_show_borders")).sendKeys("Selenium");
		
		Thread.sleep(2000);
		driver.switchTo().defaultContent();
		System.out.println("Reply -> Selenium");
		
		Thread.sleep(2000);
		driver.findElement(By.id("ctl00_ContentPlaceHolder1_btnSubmit")).sendKeys(Keys.ENTER);
