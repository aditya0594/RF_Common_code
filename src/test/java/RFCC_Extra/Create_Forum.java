...
public class Create_Forum extends BaseClass {
...
// Click Ok		
		...
		driver.findElement(By.name("ctl00$ContentPlaceHolder1$txtForum")).sendKeys("Selenium Test");
		Thread.sleep(1000);

		driver.findElement(By.name("ctl00$ContentPlaceHolder1$txtForum")).sendKeys("Selenium Test 01");
		Thread.sleep(1000);
