...
public class AL_AD_FB_Type_Master_Add_edit extends BaseClass {
    ...
    public AL_AD_FB_Type_Master_Add_edit(WebDriver rdriver) {
        driver = rdriver;
    ...
    public AL_AD_FB_Type_Master_Add_edit feedbackSelect() throws InterruptedException {
    ...
    public AL_AD_FB_Type_Master_Add_edit FeedbackMasterSelect() {
    ...
    public void feedBackTypSelect(String feedBackTypetext) {
