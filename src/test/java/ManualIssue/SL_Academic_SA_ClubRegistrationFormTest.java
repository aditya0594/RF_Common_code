...
public class SL_Academic_SA_ClubRegistrationFormTest extends BaseClass {
	...
	public void Student_Academic_Achievement() throws Exception {
        ...
        Thread.sleep(3000); 
		//Click Submit
        WebElement btn_submit = driver.findElement(By.id("ctl00$ContentPlaceHolder1$btnSubmit"));
    //    btn_submit.sendKeys(Keys.);
        btn_submit.click();
