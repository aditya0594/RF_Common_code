...
public class FireFox_AL_Academic_FRR_StudentLedgerReportTest extends BaseClass {
	...
	@Test
	public void fireFox_AL_Academic_FRR_StudentLedgerReportTest() throws Exception {

		test = reports.createTest("fireFox_AL_Academic_FRR_StudentLedgerReportTest");
