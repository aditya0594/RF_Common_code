...
public class AL_Administration_FM_Rpt_MR_PendingFilesReport extends BaseClass  {
	
	public AL_Administration_FM_Rpt_MR_PendingFilesReport(WebDriver rdriver) {
		driver = rdriver;
	...
	public AL_Administration_FM_Rpt_MR_PendingFilesReport ClickOn_MovementReports() {
		System.out.println("Click on Movement Reports ");
		MovementReports.click();
		return this;
	}
	
	public AL_Administration_FM_Rpt_MR_PendingFilesReport Select_ReportStatusDropdown() {
		System.out.println("Select Report Status Dropdown");
		Select select = new Select(ReportStatus);
		select.selectByVisibleText("Pending Files");
		return this;
	}
	
	public AL_Administration_FM_Rpt_MR_PendingFilesReport Select_SectionDropdown() {
		System.out.println("Select Section Dropdown");
		Select select = new Select(Section);
		//select.selectByVisibleText("Mr. SAIBULLA  A");
		select.selectByValue("2");
		return this;
	}
	
	public AL_Administration_FM_Rpt_MR_PendingFilesReport Select_FromDate() throws InterruptedException {
	...
	public AL_Administration_FM_Rpt_MR_PendingFilesReport Select_ToDate() throws InterruptedException {
	...
	public AL_Administration_FM_Rpt_MR_PendingFilesReport ClickOn_ShowReport() {
