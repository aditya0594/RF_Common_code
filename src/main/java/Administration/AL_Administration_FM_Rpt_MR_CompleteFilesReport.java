...
public class AL_Administration_FM_Rpt_MR_CompleteFilesReport extends BaseClass  {
	
	
	public AL_Administration_FM_Rpt_MR_CompleteFilesReport(WebDriver rdriver) {
		driver = rdriver;
	...
	@FindBy(id= "ctl00_ContentPlaceHolder1_ddluser")
	...
	public AL_Administration_FM_Rpt_MR_CompleteFilesReport ClickOn_MovementReports() {
		System.out.println("Click on Movement Reports ");
		MovementReports.click();
		return this;
	}
	
	public AL_Administration_FM_Rpt_MR_CompleteFilesReport Select_ReportStatusDropdown() {
		System.out.println("Select Report Status Dropdown");
		Select select = new Select(ReportStatus);
		select.selectByVisibleText("Complete Files");
		return this;
	}
	
	public AL_Administration_FM_Rpt_MR_CompleteFilesReport Select_SectionDropdown() {
		System.out.println("Select Section Dropdown");
		Select select = new Select(Section);
		//select.selectByVisibleText("Dr SATHICKBASHA  K");
		select.selectByValue("19");
		return this;
	}
	
	public AL_Administration_FM_Rpt_MR_CompleteFilesReport Select_FromDate() throws InterruptedException {
	...
	public AL_Administration_FM_Rpt_MR_CompleteFilesReport Select_ToDate() throws InterruptedException {
	...
	public AL_Administration_FM_Rpt_MR_CompleteFilesReport ClickOn_ShowReport() {
