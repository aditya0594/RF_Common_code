...
public class AL_Examination_COE_BundleCreation4 extends BaseClass{

	public AL_Examination_COE_BundleCreation4(WebDriver rdriver) {
		driver = rdriver;
	...
	public AL_Examination_COE_BundleCreation4 click_BundleCreation_Link() {
	...
	public AL_Examination_COE_BundleCreation4 select_College() {
	...
	public AL_Examination_COE_BundleCreation4 click_Submit_Button() {
		System.out.println("Click on Submit");
		Submit_Button.click();
		return this;
	}
	public AL_Examination_COE_BundleCreation4 click_DataWiseBundleList_Button() {
		System.out.println("Click on Date-Wise BundleReport");
		DataWiseBundleList_Button.click();
		return this;
	}
	public AL_Examination_COE_BundleCreation4 click_Report_Button() {
		System.out.println("Click on Report");
		Report_Button.click();
		return this;
	}
	public AL_Examination_COE_BundleCreation4 click_BundleSlipReport_Button() {
		System.out.println("click on Bundle Slip Report");
		BundleSlipReport_Button.click(); 
		return this;
	}
	public AL_Examination_COE_BundleCreation4 click_AcknowledgementReport_Button() {
		System.out.println("click on Acknowledgement Receipt");
		AcknowledgementReport_Button.click();
		return this;
	}
	public AL_Examination_COE_BundleCreation4 click_ExcelReport_Button() {
