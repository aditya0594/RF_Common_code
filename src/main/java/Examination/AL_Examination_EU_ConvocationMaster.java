...
public class AL_Examination_EU_ConvocationMaster extends BaseClass
{
	@FindBy(linkText = "EXAMINATION") private WebElement Examination;
	@FindBy(linkText = "Convocation") private WebElement convocation;

	
	public AL_Examination_EU_ConvocationMaster(WebDriver rdriver) {
		driver = rdriver;
		PageFactory.initElements(rdriver, this);
	}
	JavascriptExecutor js = (JavascriptExecutor) driver;
	
	public AL_Examination_EU_ConvocationMaster EXAMINATION() {
	...
	public AL_Examination_EU_ConvocationMaster Click_Convocation() {
	...
	public AL_Examination_EU_ConvocationMaster Click_Edit_btn() {
	...
	public AL_Examination_EU_ConvocationMaster Click_ActiveSatatus_chkBox() {
	...
	public AL_Examination_EU_ConvocationMaster Click_Submit_btn() {
