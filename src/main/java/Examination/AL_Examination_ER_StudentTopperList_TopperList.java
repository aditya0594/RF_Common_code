...
public class AL_Examination_ER_StudentTopperList_TopperList extends BaseClass
{
	...
	public AL_Examination_ER_StudentTopperList_TopperList(WebDriver rdriver) {
		driver = rdriver;
		PageFactory.initElements(rdriver, this);
	}
	
	public AL_Examination_ER_StudentTopperList_TopperList EXAMINATION() {
	...
	public AL_Examination_ER_StudentTopperList_TopperList EXAMINATION_REPORT() {
	...
	public AL_Examination_ER_StudentTopperList_TopperList Student_Topper_List() {
	...
	public AL_Examination_ER_StudentTopperList_TopperList Select_College_Scheme() {
	...
	public AL_Examination_ER_StudentTopperList_TopperList Select_Session() {
	...
	public AL_Examination_ER_StudentTopperList_TopperList Select_Semister() {
	...
	public AL_Examination_ER_StudentTopperList_TopperList Select_topperListOnBasis() {
	...
	public AL_Examination_ER_StudentTopperList_TopperList Select_TopRange() {
	...
	public AL_Examination_ER_StudentTopperList_TopperList Select_Course() {
	...
	public AL_Examination_ER_StudentTopperList_TopperList Click_Report_btn() {
	...
	public AL_Examination_ER_StudentTopperList_TopperList Click_MeritListRadioBtn() {
	...
	public AL_Examination_ER_StudentTopperList_TopperList Click_programBranchWiseFinalMeritListradioBtn() {
	...
	public AL_Examination_ER_StudentTopperList_TopperList Click_CourseWiseTopperListRadiobtn() {
