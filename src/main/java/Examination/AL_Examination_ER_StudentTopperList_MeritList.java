...
public class AL_Examination_ER_StudentTopperList_MeritList extends BaseClass
{
	...
	public AL_Examination_ER_StudentTopperList_MeritList(WebDriver rdriver) {
		driver = rdriver;
		PageFactory.initElements(rdriver, this);
	}
	
	public AL_Examination_ER_StudentTopperList_MeritList EXAMINATION() {
	...
	public AL_Examination_ER_StudentTopperList_MeritList EXAMINATION_REPORT() {
	...
	public AL_Examination_ER_StudentTopperList_MeritList Student_Topper_List() {
	...
	public AL_Examination_ER_StudentTopperList_MeritList Select_College_Scheme() {
	...
	public AL_Examination_ER_StudentTopperList_MeritList Select_Session() {
	...
	public AL_Examination_ER_StudentTopperList_MeritList Select_Semister() {
	...
	public AL_Examination_ER_StudentTopperList_MeritList Select_topperListOnBasis() {
	...
	public AL_Examination_ER_StudentTopperList_MeritList Select_TopRange() {
	...
	public AL_Examination_ER_StudentTopperList_MeritList Select_Course() {
	...
	public AL_Examination_ER_StudentTopperList_MeritList Click_Report_btn() {
	...
	public AL_Examination_ER_StudentTopperList_MeritList Click_MeritListRadioBtn() {
	...
	public AL_Examination_ER_StudentTopperList_MeritList Click_programBranchWiseFinalMeritListradioBtn() {
	...
	public AL_Examination_ER_StudentTopperList_MeritList Click_CourseWiseTopperListRadiobtn() {
