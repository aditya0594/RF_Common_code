...
public class AL_Examination_ER_StudentTopperList_CourseWisetoppeList extends BaseClass
{
	...
	public AL_Examination_ER_StudentTopperList_CourseWisetoppeList(WebDriver rdriver) {
		driver = rdriver;
		PageFactory.initElements(rdriver, this);
	}
	
	public AL_Examination_ER_StudentTopperList_CourseWisetoppeList EXAMINATION() {
	...
	public AL_Examination_ER_StudentTopperList_CourseWisetoppeList EXAMINATION_REPORT() {
	...
	public AL_Examination_ER_StudentTopperList_CourseWisetoppeList Student_Topper_List() {
	...
	public AL_Examination_ER_StudentTopperList_CourseWisetoppeList Select_College_Scheme() {
	...
	public AL_Examination_ER_StudentTopperList_CourseWisetoppeList Select_Session() {
	...
	public AL_Examination_ER_StudentTopperList_CourseWisetoppeList Select_Semister() {
	...
	public AL_Examination_ER_StudentTopperList_CourseWisetoppeList Select_topperListOnBasis() {
	...
	public AL_Examination_ER_StudentTopperList_CourseWisetoppeList Select_TopRange() {
	...
	public AL_Examination_ER_StudentTopperList_CourseWisetoppeList Select_Course() {
	...
	public AL_Examination_ER_StudentTopperList_CourseWisetoppeList Click_Report_btn() {
	...
	public AL_Examination_ER_StudentTopperList_CourseWisetoppeList Click_MeritListRadioBtn() {
	...
	public AL_Examination_ER_StudentTopperList_CourseWisetoppeList Click_programBranchWiseFinalMeritListradioBtn() {
	...
	public AL_Examination_ER_StudentTopperList_CourseWisetoppeList Click_CourseWiseTopperListRadiobtn() {
