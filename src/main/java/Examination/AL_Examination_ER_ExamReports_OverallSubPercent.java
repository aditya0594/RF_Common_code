...
public class AL_Examination_ER_ExamReports_OverallSubPercent extends BaseClass
{
	...
	public AL_Examination_ER_ExamReports_OverallSubPercent(WebDriver rdriver) {
		driver = rdriver;
		PageFactory.initElements(rdriver, this);
	}
	
	public AL_Examination_ER_ExamReports_OverallSubPercent EXAMINATION() {
	...
	public AL_Examination_ER_ExamReports_OverallSubPercent EXAMINATION_REPORT() {
	...
	public AL_Examination_ER_ExamReports_OverallSubPercent EXAM_REPORT() {
	...
	public AL_Examination_ER_ExamReports_OverallSubPercent College_Scheme() {
	...
	public AL_Examination_ER_ExamReports_OverallSubPercent Session() {
	...
	public AL_Examination_ER_ExamReports_OverallSubPercent Semister() {
	...
	public AL_Examination_ER_ExamReports_OverallSubPercent Section() {
	...
	public AL_Examination_ER_ExamReports_OverallSubPercent Exam_Name() {
	...
	public AL_Examination_ER_ExamReports_OverallSubPercent Sub_Exam() {
	...
	public AL_Examination_ER_ExamReports_OverallSubPercent Course() {
	...
	public AL_Examination_ER_ExamReports_OverallSubPercent overall_subject_percentage_btn() {
