...
public class AL_Payroll_Rpt_IncomeTaxReports_Form16PartB extends BaseClass
{
	public AL_Payroll_Rpt_IncomeTaxReports_Form16PartB(WebDriver rdriver) {
		driver = rdriver;
	...
	public AL_Payroll_Rpt_IncomeTaxReports_Form16PartB Click_IncomeTaxReports() throws InterruptedException {
	...
	public AL_Payroll_Rpt_IncomeTaxReports_Form16PartB Select_College() {
	...
	public AL_Payroll_Rpt_IncomeTaxReports_Form16PartB Select_Staff() {
	...
	public AL_Payroll_Rpt_IncomeTaxReports_Form16PartB Select_Employee() {
	...
	public AL_Payroll_Rpt_IncomeTaxReports_Form16PartB Click_SHowTaxbtn() {
	...
	public AL_Payroll_Rpt_IncomeTaxReports_Form16PartB Click_Form16PartBBtn() {
		System.out.println("Click on Form 16 Part B btn");
		click(form16Bbtn);
		return this;
	}
}
