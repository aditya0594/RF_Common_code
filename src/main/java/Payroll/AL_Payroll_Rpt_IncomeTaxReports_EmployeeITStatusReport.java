...
public class AL_Payroll_Rpt_IncomeTaxReports_EmployeeITStatusReport extends BaseClass
{
	public AL_Payroll_Rpt_IncomeTaxReports_EmployeeITStatusReport(WebDriver rdriver) {
		driver = rdriver;
	...
	@FindBy(id = "ctl00_ContentPlaceHolder1_btnEmployeeITStatusReport") private WebElement itstatus;

	JavascriptExecutor js = (JavascriptExecutor) driver;
	
	public AL_Payroll_Rpt_IncomeTaxReports_EmployeeITStatusReport Click_IncomeTaxReports() throws InterruptedException {
	...
	public AL_Payroll_Rpt_IncomeTaxReports_EmployeeITStatusReport Select_College() {
	...
	public AL_Payroll_Rpt_IncomeTaxReports_EmployeeITStatusReport Select_Staff() {
	...
	public AL_Payroll_Rpt_IncomeTaxReports_EmployeeITStatusReport Select_Employee() {
	...
	public AL_Payroll_Rpt_IncomeTaxReports_EmployeeITStatusReport Click_EmployeeITStatusReportBtn() {
		System.out.println("Click Employee IT Status Report btn");
		click(itstatus);
		return this;
	}
}
