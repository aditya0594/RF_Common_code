...
public class AL_Payroll_Rpt_PTPFDeductionReport_EPFReport extends BaseClass
{
	...
	public AL_Payroll_Rpt_PTPFDeductionReport_EPFReport(WebDriver rdriver) {
		driver = rdriver;
		PageFactory.initElements(rdriver, this);
	}
	
	public AL_Payroll_Rpt_PTPFDeductionReport_EPFReport PAYROLL() {
	...
	public AL_Payroll_Rpt_PTPFDeductionReport_EPFReport Reports() {
	...
	public AL_Payroll_Rpt_PTPFDeductionReport_EPFReport PF_PT_Deduction_Repo() throws InterruptedException {
	...
	public AL_Payroll_Rpt_PTPFDeductionReport_EPFReport Select_month() throws InterruptedException {
	...
	public AL_Payroll_Rpt_PTPFDeductionReport_EPFReport Select_college() throws InterruptedException {
	...
	public AL_Payroll_Rpt_PTPFDeductionReport_EPFReport Select_Staff() throws InterruptedException{
	...
	public AL_Payroll_Rpt_PTPFDeductionReport_EPFReport Click_EPFReport_btn() throws IOException, InterruptedException {
