...
public class AL_Payroll_Rpt_PTPFDeductionReport_GrossTDSReport extends BaseClass
{
	...
	public AL_Payroll_Rpt_PTPFDeductionReport_GrossTDSReport(WebDriver rdriver) {
		driver = rdriver;
		PageFactory.initElements(rdriver, this);
	}
	
	public AL_Payroll_Rpt_PTPFDeductionReport_GrossTDSReport PAYROLL() {
	...
	public AL_Payroll_Rpt_PTPFDeductionReport_GrossTDSReport Reports() {
	...
	public AL_Payroll_Rpt_PTPFDeductionReport_GrossTDSReport PF_PT_Deduction_Repo() throws InterruptedException {
	...
	public AL_Payroll_Rpt_PTPFDeductionReport_GrossTDSReport Select_month() throws InterruptedException {
	...
	public AL_Payroll_Rpt_PTPFDeductionReport_GrossTDSReport Select_college() throws InterruptedException {
	...
	public AL_Payroll_Rpt_PTPFDeductionReport_GrossTDSReport Select_Staff() throws InterruptedException{
	...
	public AL_Payroll_Rpt_PTPFDeductionReport_GrossTDSReport Click_Gross_TDS_Report_btn() throws IOException, InterruptedException {
		System.out.println("Click=> Gross and TDS Report button");
		WebElement gross = driver.findElement(By.id("ctl00_ContentPlaceHolder1_btnGrossTDSReport"));
		click(gross);
		Thread.sleep(2000);	
		return this;
	}
