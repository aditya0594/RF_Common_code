...
public class AL_Payroll_Rpt_IncomeTaxReports_ShowTax extends BaseClass
{
	public AL_Payroll_Rpt_IncomeTaxReports_ShowTax(WebDriver rdriver) {
		driver = rdriver;
	...
	public AL_Payroll_Rpt_IncomeTaxReports_ShowTax Click_IncomeTaxReports() throws InterruptedException {
	...
	public AL_Payroll_Rpt_IncomeTaxReports_ShowTax Select_College() {
	...
	public AL_Payroll_Rpt_IncomeTaxReports_ShowTax Select_Staff() {
	...
	public AL_Payroll_Rpt_IncomeTaxReports_ShowTax Select_Employee() {
	...
	public AL_Payroll_Rpt_IncomeTaxReports_ShowTax Click_SHowTaxbtn() {
		System.out.println("Click on ShowTax btn");
		click(showtaxbtn);
		return this;
	}
	
	public AL_Payroll_Rpt_IncomeTaxReports_ShowTax Click_TaxColumnBtn() {
		System.out.println("Click on Tax Column btn");
		click(taxcolumnbtn);
		return this;
	}
	
	public AL_Payroll_Rpt_IncomeTaxReports_ShowTax Click_Form16Btn() {
