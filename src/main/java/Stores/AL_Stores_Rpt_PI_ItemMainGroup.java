...
public class AL_Stores_Rpt_PI_ItemMainGroup extends BaseClass {
	...
	public AL_Stores_Rpt_PI_ItemMainGroup(WebDriver rdriver) {
		driver = rdriver;
		PageFactory.initElements(rdriver, this);
	}
	
	public AL_Stores_Rpt_PI_ItemMainGroup click_purchaseitemreport() throws InterruptedException {
	...
	public AL_Stores_Rpt_PI_ItemMainGroup Select_FromDate() {
		System.out.println("Enter From Date"); 
		clearText(fromdate);
		sendKeys(fromdate,"01/01/2021");
		return this;
	}
	public AL_Stores_Rpt_PI_ItemMainGroup Select_ToDate() {
	...
	public AL_Stores_Rpt_PI_ItemMainGroup Click_ReportBtn() {
