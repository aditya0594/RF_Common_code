...
public class AL_Stores_Rpt_SER_SecurityPassReport extends BaseClass {
...
//	JavascriptExecutor js= (JavascriptExecutor)driver;
	...
	public  AL_Stores_Rpt_SER_SecurityPassReport (WebDriver rdriver) {
		driver = rdriver;
		PageFactory.initElements(rdriver, this);
		
	}
	
	public AL_Stores_Rpt_SER_SecurityPassReport Click_STORES() {
	...
	public AL_Stores_Rpt_SER_SecurityPassReport Click_REPORTS() {
	...
	public AL_Stores_Rpt_SER_SecurityPassReport Select_ReportType() {
		System.out.println("Admin Examination menu selected > Select Report Type");
		Select select = new Select(ReportType);
		select.selectByVisibleText("Security Pass Report");
		return this;
	}    
	  
	public AL_Stores_Rpt_SER_SecurityPassReport Select_StoreName() throws InterruptedException {
		System.out.println("Admin Examination menu selected > Select Store Name => CRESCENT INST");
...
//		select.selectByVisibleText("CRESCENT INST");
	...
	public AL_Stores_Rpt_SER_SecurityPassReport Click_ShowBtn() {
