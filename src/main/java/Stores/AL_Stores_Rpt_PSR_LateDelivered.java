...
public class AL_Stores_Rpt_PSR_LateDelivered extends BaseClass {
	...
	public AL_Stores_Rpt_PSR_LateDelivered(WebDriver rdriver) {
		driver = rdriver;
		PageFactory.initElements(rdriver, this);
	}

	public AL_Stores_Rpt_PSR_LateDelivered click_POStockReports() throws InterruptedException {
	...
	public AL_Stores_Rpt_PSR_LateDelivered Select_FromDate() {
	...
	public AL_Stores_Rpt_PSR_LateDelivered Select_ToDate() {
	...
	public AL_Stores_Rpt_PSR_LateDelivered Select_POType() {
		System.out.println("Select PO Tyep");
		click(item);
		itemname.sendKeys("Delivered",Keys.ENTER);
		return this;
	}
	
	
	public AL_Stores_Rpt_PSR_LateDelivered Click_ReportBtn() {
		System.out.println("Click Report Button");
		click(btnreport);
		return this;
	}
	
	public AL_Stores_Rpt_PSR_LateDelivered Select_lateDratioBtn() {
		System.out.println("Click Late Delivered Radio Button");
		click(latedeliver);
		return this;
	}
}
