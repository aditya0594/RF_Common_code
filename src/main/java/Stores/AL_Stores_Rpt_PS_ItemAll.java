...
public class AL_Stores_Rpt_PS_ItemAll extends BaseClass {
	...
	public AL_Stores_Rpt_PS_ItemAll(WebDriver rdriver) {
		driver = rdriver;
		PageFactory.initElements(rdriver, this);
	}

	public AL_Stores_Rpt_PS_ItemAll click_PurchaseSummary() throws InterruptedException {
	...
	public AL_Stores_Rpt_PS_ItemAll Select_FromDate() {
		System.out.println("Enter From Date");
		js.executeScript("arguments[0].value='01/01/2021';", fromdate); 
		return this;
	}

	public AL_Stores_Rpt_PS_ItemAll Select_ToDate() {
		System.out.println("Enter To Date");
		js.executeScript("arguments[0].value='19/12/2024';", todate); 
		return this;
	}
	
	public AL_Stores_Rpt_PS_ItemAll Click_PerticularRadioBtn() {
		System.out.println("Click perticular Radio Button");
		click(perticular);
		return this;
	}
	
	public AL_Stores_Rpt_PS_ItemAll Select_Item() {
	...
	public AL_Stores_Rpt_PS_ItemAll Click_ReportBtn() {
		System.out.println("Click Report Button");
		click(btnreport);
		return this;
	}
	public AL_Stores_Rpt_PS_ItemAll Select_itemraidobtn() {
