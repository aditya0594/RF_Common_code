...
public class AL_Stores_Rpt_PSR_DeliveredAll extends BaseClass {
	...
	public AL_Stores_Rpt_PSR_DeliveredAll(WebDriver rdriver) {
		driver = rdriver;
		PageFactory.initElements(rdriver, this);
	}

	public AL_Stores_Rpt_PSR_DeliveredAll click_POStockReports() throws InterruptedException {
	...
	public AL_Stores_Rpt_PSR_DeliveredAll Select_FromDate() {
	...
	public AL_Stores_Rpt_PSR_DeliveredAll Select_ToDate() {
	...
	public AL_Stores_Rpt_PSR_DeliveredAll Select_POType() {
	...
	public AL_Stores_Rpt_PSR_DeliveredAll Click_ReportBtn() {
