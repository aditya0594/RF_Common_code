...
public class AL_Stores_Rpt_CDWR_MainStore_DetailReport extends BaseClass {
	...
	public  AL_Stores_Rpt_CDWR_MainStore_DetailReport(WebDriver rdriver) {
		driver = rdriver;
		PageFactory.initElements(rdriver, this);
		
	}
	
	public AL_Stores_Rpt_CDWR_MainStore_DetailReport ClickOn_ClgOrDeptWiseItemReport1() {
	...
	public AL_Stores_Rpt_CDWR_MainStore_DetailReport Select_FromDate() throws InterruptedException {
	...
	public  AL_Stores_Rpt_CDWR_MainStore_DetailReport Select_ToDate() throws InterruptedException {
	...
	public AL_Stores_Rpt_CDWR_MainStore_DetailReport ClickOn_ClgOrDeptWiseItemReportDetailed() throws InterruptedException {
		System.out.println(" Click ClgOrDeptWiseItemReport Main Store Detailed Report ");
