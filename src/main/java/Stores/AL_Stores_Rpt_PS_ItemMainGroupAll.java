...
public class AL_Stores_Rpt_PS_ItemMainGroupAll extends BaseClass {
	...
	public AL_Stores_Rpt_PS_ItemMainGroupAll(WebDriver rdriver) {
		driver = rdriver;
		PageFactory.initElements(rdriver, this);
	}

	public AL_Stores_Rpt_PS_ItemMainGroupAll click_PurchaseSummary() throws InterruptedException {
	...
	public AL_Stores_Rpt_PS_ItemMainGroupAll Select_FromDate() {
		System.out.println("Enter From Date");
		js.executeScript("arguments[0].value='01/01/2021';", fromdate); 
		return this;
	}

	public AL_Stores_Rpt_PS_ItemMainGroupAll Select_ToDate() {
		System.out.println("Enter To Date");
		js.executeScript("arguments[0].value='19/12/2024';", todate); 
		return this;
	}
	
	public AL_Stores_Rpt_PS_ItemMainGroupAll Click_ReportBtn() {
