...
public class AL_Stores_Rpt_PSR_DeliveredDateCrossed extends BaseClass {
	...
	@FindBy(id = "ctl00_ContentPlaceHolder1_rblNotDelivered_1")
	private WebElement delivereddatecross;

	JavascriptExecutor js = (JavascriptExecutor) driver;

	public AL_Stores_Rpt_PSR_DeliveredDateCrossed(WebDriver rdriver) {
		driver = rdriver;
		PageFactory.initElements(rdriver, this);
	}

	public AL_Stores_Rpt_PSR_DeliveredDateCrossed click_POStockReports() throws InterruptedException {
	...
	public AL_Stores_Rpt_PSR_DeliveredDateCrossed Select_FromDate() {
		System.out.println("Enter From Date");
		js.executeScript("arguments[0].value='01/01/2021';", fromdate);
		return this;
	}

	public AL_Stores_Rpt_PSR_DeliveredDateCrossed Select_ToDate() {
		System.out.println("Enter To Date");
		js.executeScript("arguments[0].value='19/12/2024';", todate);
		return this;
	}

	public AL_Stores_Rpt_PSR_DeliveredDateCrossed Select_POType() {
	...
	public AL_Stores_Rpt_PSR_DeliveredDateCrossed Click_ReportBtn() {
		System.out.println("Click Report Button");
		click(btnreport);
		return this;
	}

	public AL_Stores_Rpt_PSR_DeliveredDateCrossed Select_DeliverDateCross() {
		System.out.println("Click Delivered Date Crossed Radio Button");
		click(delivereddatecross);
		return this;
	}
}
