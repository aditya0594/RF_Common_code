...
public class AL_Academic_FB_CFR_TeacherWiseFeedbackEvalution extends BaseClass
{
	public AL_Academic_FB_CFR_TeacherWiseFeedbackEvalution(WebDriver rdriver) {
		driver = rdriver;
...
//	@FindBy(xpath ="ctl00_ContentPlaceHolder1_btnReport") private WebElement FacultyFeedbackReport;
	@FindBy(id ="ctl00_ContentPlaceHolder1_btnReport") private WebElement teacherwisefeedbackevalution;
	
	
	
	//

	public AL_Academic_FB_CFR_TeacherWiseFeedbackEvalution ACADEMIC() {
	...
	public AL_Academic_FB_CFR_TeacherWiseFeedbackEvalution FeedBack() {
	...
	public AL_Academic_FB_CFR_TeacherWiseFeedbackEvalution CommonFeedbackReport() {
		System.out.println(" Click on Common Feedback Report");
		CommonFeedbackReport.click();
		return this;
	}

	public AL_Academic_FB_CFR_TeacherWiseFeedbackEvalution SelectReport() {
		System.out.println("Select Report  > TEACHER WISE FEEDBACK EVALUTION REPORT(EXCEL)");
		Select c = new Select(SelectReport);
		c.selectByVisibleText("TEACHER WISE FEEDBACK EVALUTION REPORT(EXCEL)");
		return this;
	}
	
	public AL_Academic_FB_CFR_TeacherWiseFeedbackEvalution SelectSession() {
	...
	public AL_Academic_FB_CFR_TeacherWiseFeedbackEvalution SelectCollege() {
	...
	public AL_Academic_FB_CFR_TeacherWiseFeedbackEvalution SelectSemester() {
...
//	}
	...
	public AL_Academic_FB_CFR_TeacherWiseFeedbackEvalution FeedBackType() {
	...
	public AL_Academic_FB_CFR_TeacherWiseFeedbackEvalution TeacherWiseFeedbackEvalution() {
		System.out.println("Click on Teacher Wise Feedback Evalution Btn");
		click(teacherwisefeedbackevalution);
		return this;
	}
}
