...
public class SL_Academic_SR_SCD_AttendanceDetails extends BaseClass
{
	public SL_Academic_SR_SCD_AttendanceDetails(WebDriver rdriver) {
		driver = rdriver;
	...
	public SL_Academic_SR_SCD_AttendanceDetails loginPage() throws InterruptedException {
	...
	public SL_Academic_SR_SCD_AttendanceDetails Click_StudentCompleteDetail_Link() throws InterruptedException {
		js.executeScript("arguments[0].click();", Student_Complete_Detail_Link);
		System.out.println("Click on Student Complete Detail");
		return this;
	}

	public SL_Academic_SR_SCD_AttendanceDetails Click_AttendanceDetails() {
		js.executeScript("arguments[0].click();", AttendanceDetails);
	...
	public SL_Academic_SR_SCD_AttendanceDetails Select_Session() {
