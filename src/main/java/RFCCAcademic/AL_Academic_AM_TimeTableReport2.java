...
public class AL_Academic_AM_TimeTableReport2 extends BaseClass{

	public AL_Academic_AM_TimeTableReport2(WebDriver rdriver) {
		driver = rdriver;
	...
	public AL_Academic_AM_TimeTableReport2 click_TimeTableReport_Link() {
		js.executeScript("arguments[0].click();",timeTableReport_Link );
		System.out.println("Time Table Report click");
		return this;
	}
	public AL_Academic_AM_TimeTableReport2 select_College() {
	...
	public AL_Academic_AM_TimeTableReport2 select_Session() {
