...
public class AL_Academic_FRR_FR_OnlineDCRExcelReport extends BaseClass
{
	public AL_Academic_FRR_FR_OnlineDCRExcelReport(WebDriver rdriver) {
		driver = rdriver;
	...
	public AL_Academic_FRR_FR_OnlineDCRExcelReport Click_FeesReport() throws Exception {
	...
	public AL_Academic_FRR_FR_OnlineDCRExcelReport Select_ReportType() throws Exception {
		System.out.println("Select Report Type ==> Online DCR Excel Report");
		threadWait1();
		Select select = new Select(reportDropdown);
		select.selectByVisibleText("Online DCR Excel Report");
		return this;
	}
	
	public AL_Academic_FRR_FR_OnlineDCRExcelReport Enter_FromDate() throws Exception {
	...
	public AL_Academic_FRR_FR_OnlineDCRExcelReport Enter_ToDate() throws Exception {
	...
	public AL_Academic_FRR_FR_OnlineDCRExcelReport Select_Degree() throws Exception {
	...
	public AL_Academic_FRR_FR_OnlineDCRExcelReport Click_SelectCheckbox() throws Exception {
	...
	public AL_Academic_FRR_FR_OnlineDCRExcelReport Click_ExcelReportButton() throws Exception {
