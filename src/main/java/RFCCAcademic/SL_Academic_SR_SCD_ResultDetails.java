...
public class SL_Academic_SR_SCD_ResultDetails extends BaseClass
{
	public SL_Academic_SR_SCD_ResultDetails(WebDriver rdriver) {
		driver = rdriver;
	...
	@FindBy(id = "ctl00_ContentPlaceHolder1_rdolistSemester_0")
	private WebElement resultI;
	
	@FindBy(id = "ctl00_ContentPlaceHolder1_lvSession_ctrl0_imgbtnpreview")
	private WebElement printicon;
	
	
	JavascriptExecutor js = (JavascriptExecutor)driver;
	
	public SL_Academic_SR_SCD_ResultDetails loginPage() throws InterruptedException {
	...
	public SL_Academic_SR_SCD_ResultDetails Click_StudentCompleteDetail_Link() throws InterruptedException {
		js.executeScript("arguments[0].click();", Student_Complete_Detail_Link);
		System.out.println("Click on Student Complete Detail");
		return this;
	}

	public SL_Academic_SR_SCD_ResultDetails Click_ResultDetails() {
		js.executeScript("arguments[0].click();", ResultDetails);
	...
	public SL_Academic_SR_SCD_ResultDetails Select_Session() {
	...
	public SL_Academic_SR_SCD_ResultDetails Click_I_btn() {
		resultI.click();
		System.out.println("Click on I btn");
		return this;
	}
	
	public SL_Academic_SR_SCD_ResultDetails Click_PrintIcon() {
		js.executeScript("arguments[0].click();", printicon);
		System.out.println("Click on Print icon");
		return this;
	}
