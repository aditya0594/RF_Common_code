...
public class AL_Academic_FB_CFR_FacultyFeedbackReport extends BaseClass {

	public AL_Academic_FB_CFR_FacultyFeedbackReport(WebDriver rdriver) {
		driver = rdriver;
...
//	@FindBy(xpath ="ctl00_ContentPlaceHolder1_btnReport") private WebElement FacultyFeedbackReport;
	@FindBy(id ="ctl00_ContentPlaceHolder1_btnReport") private WebElement FacultyFeedbackReportbtn;
	
	
	
	//

	public AL_Academic_FB_CFR_FacultyFeedbackReport ACADEMIC() {
	...
	public AL_Academic_FB_CFR_FacultyFeedbackReport FeedBack() {
	...
	public AL_Academic_FB_CFR_FacultyFeedbackReport CommonFeedbackReport() {
		System.out.println(" Click on Common Feedback Report");
		CommonFeedbackReport.click();
		return this;
	}

	public AL_Academic_FB_CFR_FacultyFeedbackReport SelectReport() {
		System.out.println("Select Report  > FACULTY FEEDBACK REPORT");
		Select c = new Select(SelectReport);
		c.selectByVisibleText("FACULTY FEEDBACK REPORT");
		return this;
	}
	
	public AL_Academic_FB_CFR_FacultyFeedbackReport SelectSession() {
	...
	public AL_Academic_FB_CFR_FacultyFeedbackReport SelectCollege() {
	...
	public AL_Academic_FB_CFR_FacultyFeedbackReport SelectSemester() {
	...
	public AL_Academic_FB_CFR_FacultyFeedbackReport SelectFormat() {
	...
	public AL_Academic_FB_CFR_FacultyFeedbackReport FeedBackType() {
	...
	public AL_Academic_FB_CFR_FacultyFeedbackReport FacultyFeedbackReport() {
		System.out.println("select format");
		click(FacultyFeedbackReportbtn);
		return this;
	}
