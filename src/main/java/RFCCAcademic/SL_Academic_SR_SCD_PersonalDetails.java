...
public class SL_Academic_SR_SCD_PersonalDetails extends BaseClass
{
	public SL_Academic_SR_SCD_PersonalDetails(WebDriver rdriver) {
		driver = rdriver;
	...
	public SL_Academic_SR_SCD_PersonalDetails loginPage() throws InterruptedException {
	...
	public SL_Academic_SR_SCD_PersonalDetails Click_StudentCompleteDetail_Link() throws InterruptedException {
		js.executeScript("arguments[0].click();", Student_Complete_Detail_Link);
		System.out.println("Click on Student Complete Detail");
		return this;
	}

	public SL_Academic_SR_SCD_PersonalDetails Click_Personal_Details() {
		js.executeScript("arguments[0].click();", personal_Details);
