...
public class AL_Academic_FRR_FR_DailyFeeCollectionReport extends BaseClass
{
	public AL_Academic_FRR_FR_DailyFeeCollectionReport(WebDriver rdriver) {
		driver = rdriver;
	...
	public AL_Academic_FRR_FR_DailyFeeCollectionReport Click_FeesReport() throws Exception {
	...
	public AL_Academic_FRR_FR_DailyFeeCollectionReport Select_ReportType() throws Exception {
		System.out.println("Select Report Type ==> Daily Fee Collection Report");
		Thread.sleep(2000);
		Select select = new Select(reportDropdown);
		select.selectByVisibleText("Daily Fee Collection Report");
		return this;
	}
	
	public AL_Academic_FRR_FR_DailyFeeCollectionReport Enter_FromDate() throws Exception {
	...
	public AL_Academic_FRR_FR_DailyFeeCollectionReport Enter_ToDate() throws Exception {
	...
	public AL_Academic_FRR_FR_DailyFeeCollectionReport Select_College() throws Exception {
	...
	public AL_Academic_FRR_FR_DailyFeeCollectionReport Select_Degree() throws Exception {
	...
	public AL_Academic_FRR_FR_DailyFeeCollectionReport Click_ReceiptTypeCheckbox() throws Exception {
	...
	public AL_Academic_FRR_FR_DailyFeeCollectionReport Click_ReportButton() throws Exception {
