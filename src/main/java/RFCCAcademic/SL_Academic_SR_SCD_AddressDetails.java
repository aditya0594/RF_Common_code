...
public class SL_Academic_SR_SCD_AddressDetails extends BaseClass
{
	public SL_Academic_SR_SCD_AddressDetails(WebDriver rdriver) {
		driver = rdriver;
	...
	private WebElement address_Details;
	
	@FindBy(xpath = "(//span[@id='ctl00_ContentPlaceHolder1_lblDYPermanentAddress_PD'])[1]")
	...
	public SL_Academic_SR_SCD_AddressDetails loginPage() throws InterruptedException {
	...
	public SL_Academic_SR_SCD_AddressDetails Click_StudentCompleteDetail_Link() throws InterruptedException {
		js.executeScript("arguments[0].click();", Student_Complete_Detail_Link);
		System.out.println("Click on Student Complete Detail");
		return this;
	}

	public SL_Academic_SR_SCD_AddressDetails Click_AddressDetails() {
		js.executeScript("arguments[0].click();", address_Details);
