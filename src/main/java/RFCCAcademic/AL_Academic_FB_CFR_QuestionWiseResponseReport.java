...
public class AL_Academic_FB_CFR_QuestionWiseResponseReport extends BaseClass
{
	public AL_Academic_FB_CFR_QuestionWiseResponseReport(WebDriver rdriver) {
		driver = rdriver;
...
//	@FindBy(xpath ="ctl00_ContentPlaceHolder1_btnReport") private WebElement FacultyFeedbackReport;
	@FindBy(xpath ="(//input[@id='ctl00_ContentPlaceHolder1_btnReport'])[1]") private WebElement QuestionWiseResponseReportbtn;
	
	
	
	//

	public AL_Academic_FB_CFR_QuestionWiseResponseReport ACADEMIC() {
	...
	public AL_Academic_FB_CFR_QuestionWiseResponseReport FeedBack() {
	...
	public AL_Academic_FB_CFR_QuestionWiseResponseReport CommonFeedbackReport() {
		System.out.println(" Click on Common Feedback Report");
		CommonFeedbackReport.click();
		return this;
	}

	public AL_Academic_FB_CFR_QuestionWiseResponseReport SelectReport() {
		System.out.println("Select Report  > QUESTION WISE RESPONSE REPORT(EXCEL)");
		Select c = new Select(SelectReport);
		c.selectByVisibleText("QUESTION WISE RESPONSE REPORT(EXCEL)");
		return this;
	}
	
	public AL_Academic_FB_CFR_QuestionWiseResponseReport SelectSession() {
	...
	public AL_Academic_FB_CFR_QuestionWiseResponseReport SelectCollege() {
	...
	public AL_Academic_FB_CFR_QuestionWiseResponseReport SelectSemester() {
...
//	}
	...
	public AL_Academic_FB_CFR_QuestionWiseResponseReport FeedBackType() {
	...
	public AL_Academic_FB_CFR_QuestionWiseResponseReport QuestionWiseResponseReportbtn() {
		System.out.println("Click on Question Wise Response Report Btn");
		click(QuestionWiseResponseReportbtn);
		return this;
	}
}
