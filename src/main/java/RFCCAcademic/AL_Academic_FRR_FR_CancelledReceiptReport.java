...
public class AL_Academic_FRR_FR_CancelledReceiptReport extends BaseClass
{
	public AL_Academic_FRR_FR_CancelledReceiptReport(WebDriver rdriver) {
		driver = rdriver;
	...
	public AL_Academic_FRR_FR_CancelledReceiptReport Click_FeesReport() throws Exception {
	...
	public AL_Academic_FRR_FR_CancelledReceiptReport Select_ReportType() throws Exception {
		System.out.println("Select Report Type ==> Cancelled Receipt Report (PDF)");
		Thread.sleep(2000);
		Select select = new Select(reportDropdown);
		select.selectByVisibleText("Cancelled Receipt Report (PDF)");
		return this;
	}
	
	public AL_Academic_FRR_FR_CancelledReceiptReport Enter_FromDate() throws Exception {
	...
	public AL_Academic_FRR_FR_CancelledReceiptReport Enter_ToDate() throws Exception {
	...
	public AL_Academic_FRR_FR_CancelledReceiptReport Click_ReceiptTypeCheckbox() throws Exception {
	...
	public AL_Academic_FRR_FR_CancelledReceiptReport Click_ReportButton() throws Exception {
