...
public class AL_Academic_FRR_FR_SFDR_RefundLedger extends BaseClass
{
	public AL_Academic_FRR_FR_SFDR_RefundLedger(WebDriver rdriver) {
		driver = rdriver;
	...
	public AL_Academic_FRR_FR_SFDR_RefundLedger Click_FeesReport() throws Exception {
	...
	public AL_Academic_FRR_FR_SFDR_RefundLedger Click_SelectedFieldDCRReport() throws Exception {
	...
	public AL_Academic_FRR_FR_SFDR_RefundLedger Select_ReportType() throws Exception {
		System.out.println("Select Report Type ==> Refund Ledger");
		Thread.sleep(2000);
		Select select = new Select(reportSelectionDropdown);
		select.selectByVisibleText("Refund Ledger");
		return this;
	}
	
	public AL_Academic_FRR_FR_SFDR_RefundLedger Select_ReceiptType() throws Exception {
	...
	public AL_Academic_FRR_FR_SFDR_RefundLedger Click_MultiSelectField() throws Exception {
	...
	public AL_Academic_FRR_FR_SFDR_RefundLedger Click_SelectAllCheckbox() throws Exception {
	...
	public AL_Academic_FRR_FR_SFDR_RefundLedger Enter_FromDate() throws Exception {
	...
	public AL_Academic_FRR_FR_SFDR_RefundLedger Enter_ToDate() throws Exception {
	...
	public AL_Academic_FRR_FR_SFDR_RefundLedger Click_ShowButton() throws Exception {
	...
	public AL_Academic_FRR_FR_SFDR_RefundLedger Verify_Student() throws Exception {
		System.out.println("Verify Student");
		WebElement stud1 = driver.findElement(By.xpath("(//td[contains(text(),'Crescent School of Architecture')])[1]"));
		
		String Expected_Msg = "Crescent School of Architecture"; 
		String Actual_Msg = stud1.getText();
