...
public class FL_Academic_FR_CreateTeachingPlan_DeleteFlow01_2 extends BaseClass {

	public FL_Academic_FR_CreateTeachingPlan_DeleteFlow01_2(WebDriver rdriver) {
		driver = rdriver;
	...
	@FindBy(id = "ctl00_ContentPlaceHolder1_lvTeachingPlan_ctrl0_btnDelete")
	private WebElement deleteicon;
	@FindBy(xpath = "//button[normalize-space()='OK']")
	private WebElement deleteiconok;
	...
	public FL_Academic_FR_CreateTeachingPlan_DeleteFlow01_2 click_teachingPlanEntry_link() {
	...
	public FL_Academic_FR_CreateTeachingPlan_DeleteFlow01_2 SelectCourseTest() throws Exception {
	...
	public FL_Academic_FR_CreateTeachingPlan_DeleteFlow01_2 select_session() {
	...
	public FL_Academic_FR_CreateTeachingPlan_DeleteFlow01_2 select_college() {
		System.out.println(
	...
	public FL_Academic_FR_CreateTeachingPlan_DeleteFlow01_2 select_semester() {
	...
	public FL_Academic_FR_CreateTeachingPlan_DeleteFlow01_2 select_section() {
	...
	public FL_Academic_FR_CreateTeachingPlan_DeleteFlow01_2 click_deleteIcon() {
	...
	public FL_Academic_FR_CreateTeachingPlan_DeleteFlow01_2 login() {
