...
public class AL_Establishment_Rpt_LeaveReport_type_OD extends BaseClass
{
	...
	public AL_Establishment_Rpt_LeaveReport_type_OD(WebDriver rdriver) {
		driver = rdriver;
		PageFactory.initElements(rdriver, this);
	}
	
	public AL_Establishment_Rpt_LeaveReport_type_OD Click_ESTABLISHMENT() {
	...
	public AL_Establishment_Rpt_LeaveReport_type_OD Click_REPORTS() {
	...
	public AL_Establishment_Rpt_LeaveReport_type_OD Click_LeaveReport() throws InterruptedException {
	...
	public AL_Establishment_Rpt_LeaveReport_type_OD Select_College_name() {
	...
	public AL_Establishment_Rpt_LeaveReport_type_OD Select_leave() {
	...
	public AL_Establishment_Rpt_LeaveReport_type_OD Select_Stafff_Type() {
	...
	public AL_Establishment_Rpt_LeaveReport_type_OD Set_from_date() {
	...
	public AL_Establishment_Rpt_LeaveReport_type_OD Set_to_date() {
	...
	public AL_Establishment_Rpt_LeaveReport_type_OD Click_report_btn() {
	...
	public AL_Establishment_Rpt_LeaveReport_type_OD Click_OD_type_radioBtn() {
		System.out.println("Click OD radio_button");
		WebElement od_btn=driver.findElement(By.id("ctl00_ContentPlaceHolder1_rdbleavestatus_1"));
		click(od_btn);
		return this;
	}
