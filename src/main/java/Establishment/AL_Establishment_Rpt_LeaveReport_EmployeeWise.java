...
public class AL_Establishment_Rpt_LeaveReport_EmployeeWise extends BaseClass
{
	...
	public AL_Establishment_Rpt_LeaveReport_EmployeeWise(WebDriver rdriver) {
		driver = rdriver;
		PageFactory.initElements(rdriver, this);
	}
	
	public AL_Establishment_Rpt_LeaveReport_EmployeeWise Click_ESTABLISHMENT() {
	...
	public AL_Establishment_Rpt_LeaveReport_EmployeeWise Click_REPORTS() {
	...
	public AL_Establishment_Rpt_LeaveReport_EmployeeWise Click_LeaveReport() throws InterruptedException {
	...
	public AL_Establishment_Rpt_LeaveReport_EmployeeWise Select_College_name() {
	...
	public AL_Establishment_Rpt_LeaveReport_EmployeeWise Select_leave() {
	...
	public AL_Establishment_Rpt_LeaveReport_EmployeeWise Select_Stafff_Type() {
	...
	public AL_Establishment_Rpt_LeaveReport_EmployeeWise Set_from_date() {
	...
	public AL_Establishment_Rpt_LeaveReport_EmployeeWise Set_to_date() {
	...
	public AL_Establishment_Rpt_LeaveReport_EmployeeWise Click_EmpolyeeWise_checkBox() {
		System.out.println("Click Empolyee Wise check box");
		WebElement emp_chk=driver.findElement(By.id("ctl00_ContentPlaceHolder1_chkEmployee"));
		click(emp_chk);
		return this;
	}
	
	public AL_Establishment_Rpt_LeaveReport_EmployeeWise Select_EmployeeName() {
		System.out.println("Select Employee Name");
		WebElement empName=driver.findElement(By.xpath("//select[@name='ctl00$ContentPlaceHolder1$ddlEmployee']"));
		Select select = new Select(empName);
		select.selectByValue("58");       // VENKATESAN  MURTHY[58]
		return this;
	}
	
	public AL_Establishment_Rpt_LeaveReport_EmployeeWise Click_EmployeeReport_btn() {
		System.out.println("Click Employee Report button");
		WebElement repo_btn=driver.findElement(By.id("ctl00_ContentPlaceHolder1_btnEmployeeRpt"));
		click(repo_btn);
		return this;
	}
