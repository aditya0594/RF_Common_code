...
public class AL_Establishment_Rpt_LeaveStatus_Report extends BaseClass
{
...
//	@FindBy(linkText = "Leave Status") private WebElement Leave_Status;
	...
	public AL_Establishment_Rpt_LeaveStatus_Report(WebDriver rdriver) {
		driver = rdriver;
		PageFactory.initElements(rdriver, this);
	}
	
	public AL_Establishment_Rpt_LeaveStatus_Report Click_ESTABLISHMENT() {
	...
	public AL_Establishment_Rpt_LeaveStatus_Report Click_REPORTS() {
	...
	public AL_Establishment_Rpt_LeaveStatus_Report Click_Leave_status() throws InterruptedException {
...
//		action.moveToElement(Leave_Status).click().build().perform();
	...
	public AL_Establishment_Rpt_LeaveStatus_Report Select_College() {
	...
	public AL_Establishment_Rpt_LeaveStatus_Report Select_Stafff_Type() {
	...
	public AL_Establishment_Rpt_LeaveStatus_Report Click_perticular_employee_check_btn() throws InterruptedException {
	...
	public AL_Establishment_Rpt_LeaveStatus_Report Select_employee() throws InterruptedException {
	...
	public AL_Establishment_Rpt_LeaveStatus_Report Set_from_date() {
	...
	public AL_Establishment_Rpt_LeaveStatus_Report Set_to_date() {
	...
	public AL_Establishment_Rpt_LeaveStatus_Report Click_report_btn() {
	...
	public AL_Establishment_Rpt_LeaveStatus_Report Click_authority_satus_report_btn() {
	...
	public AL_Establishment_Rpt_LeaveStatus_Report Select_periticular_employee() throws InterruptedException {
		System.out.println("Select Perticular Employee Check_btn");
		
		Click_perticular_employee_check_btn();
