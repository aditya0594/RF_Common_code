...
public class AL_Establishment_Rpt_LeaveReport_type_Leave extends BaseClass
{
	...
	public AL_Establishment_Rpt_LeaveReport_type_Leave(WebDriver rdriver) {
		driver = rdriver;
		PageFactory.initElements(rdriver, this);
	}
	
	public AL_Establishment_Rpt_LeaveReport_type_Leave Click_ESTABLISHMENT() {
	...
	public AL_Establishment_Rpt_LeaveReport_type_Leave Click_REPORTS() {
	...
	public AL_Establishment_Rpt_LeaveReport_type_Leave Click_LeaveReport() throws InterruptedException {
	...
	public AL_Establishment_Rpt_LeaveReport_type_Leave Select_College_name() {
	...
	public AL_Establishment_Rpt_LeaveReport_type_Leave Select_leave() {
	...
	public AL_Establishment_Rpt_LeaveReport_type_Leave Select_Stafff_Type() {
	...
	public AL_Establishment_Rpt_LeaveReport_type_Leave Set_from_date() {
	...
	public AL_Establishment_Rpt_LeaveReport_type_Leave Set_to_date() {
	...
	public AL_Establishment_Rpt_LeaveReport_type_Leave Click_type_leave_radioBtn() {
		System.out.println("Click Leave radio_button");
		WebElement leave_radio_btn=driver.findElement(By.id("ctl00_ContentPlaceHolder1_rdbleavestatus_0"));
		click(leave_radio_btn);
		return this;
	}
	
	public AL_Establishment_Rpt_LeaveReport_type_Leave Click_report_btn() {
