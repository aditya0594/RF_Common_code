...
public class AL_Establishment_Rpt_BioConsoRpt_InOutReport extends BaseClass
{
	...
	public AL_Establishment_Rpt_BioConsoRpt_InOutReport(WebDriver rdriver) {
		driver = rdriver;
		PageFactory.initElements(rdriver, this);
	}
	
	public AL_Establishment_Rpt_BioConsoRpt_InOutReport Click_ESTABLISHMENT() {
	...
	public AL_Establishment_Rpt_BioConsoRpt_InOutReport Click_REPORTS() {
	...
	public AL_Establishment_Rpt_BioConsoRpt_InOutReport Click_BiometricConsolidateReport() throws InterruptedException {
	...
	public AL_Establishment_Rpt_BioConsoRpt_InOutReport Select_College_name() {
	...
	public AL_Establishment_Rpt_BioConsoRpt_InOutReport Select_Stafff_Type() {
	...
	public AL_Establishment_Rpt_BioConsoRpt_InOutReport Set_from_date() {
	...
	public AL_Establishment_Rpt_BioConsoRpt_InOutReport Set_to_date() {
	...
	public AL_Establishment_Rpt_BioConsoRpt_InOutReport Click_report_btn() {
	...
	public AL_Establishment_Rpt_BioConsoRpt_InOutReport Click_In_Out_report_btn() {
		System.out.println("Click In Out report Button");
		WebElement repo_btn=driver.findElement(By.id("ctl00_ContentPlaceHolder1_btnReport1"));
		click(repo_btn);
		return this;
	}
	
	public AL_Establishment_Rpt_BioConsoRpt_InOutReport Select_employee() throws InterruptedException {
	...
	public AL_Establishment_Rpt_BioConsoRpt_InOutReport Select_perticular_employee_check_btn() {
	...
	public AL_Establishment_Rpt_BioConsoRpt_InOutReport set_perticular_employee_info() throws InterruptedException {
