...
public class FL_ELearning_Trans_CreateQuestionBank_DeleteFlow04_2 extends BaseClass {

	public FL_ELearning_Trans_CreateQuestionBank_DeleteFlow04_2(WebDriver driver) {
	...
	private WebElement seartxt;
	
	@FindBy(xpath = "//*[@id=\"ctl00_ContentPlaceHolder1_lvQuestions_ctrl0_btnDelete\"]")
	private WebElement delbtn;
	
	@FindBy(id = "ctl00_ContentPlaceHolder1_btnOkDel")
	private WebElement delbtnok;
	...
	public FL_ELearning_Trans_CreateQuestionBank_DeleteFlow04_2 HoverELearningTest() {
		System.out.println("Hover to E-Learning");
		action.moveToElement(ELearning).perform();
		return this;
	}

	public FL_ELearning_Trans_CreateQuestionBank_DeleteFlow04_2 ClickTrnasctionTest() {
		System.out.println("Click on Transaction");
		action.moveToElement(Transactions).click().perform();
		return this;
	}

	public FL_ELearning_Trans_CreateQuestionBank_DeleteFlow04_2 SelectCourseTest() throws Exception {
	...
	public FL_ELearning_Trans_CreateQuestionBank_DeleteFlow04_2 ClickCreateQuestionBankPageTest() throws Throwable {
	...
	public FL_ELearning_Trans_CreateQuestionBank_DeleteFlow04_2 login() {
		// Thread.sleep(1000);
...
//	Thread.sleep(2000);
	...
	public FL_ELearning_Trans_CreateQuestionBank_DeleteFlow04_2 SearchText() {
		sendKeys(seartxt,"SAD");
		return this;
	}
	
	public FL_ELearning_Trans_CreateQuestionBank_DeleteFlow04_2 ClickDelete() {
		click(delbtn);
		return this;
	}
	
	public FL_ELearning_Trans_CreateQuestionBank_DeleteFlow04_2 ClickDeleteOK() {
		click(delbtnok);
		return this;
	}
