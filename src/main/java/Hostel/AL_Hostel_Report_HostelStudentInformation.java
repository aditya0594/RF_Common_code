...
public class AL_Hostel_Report_HostelStudentInformation extends BaseClass {
	public AL_Hostel_Report_HostelStudentInformation(WebDriver rdriver) {
		driver = rdriver;
	...
	@FindBy(id="ctl00_ContentPlaceHolder1_btnPrintReport")
	private WebElement reportbtn;
	@FindBy(className = "select2-search__field")
	private WebElement SearchBoxOfDropDown;
	
	public AL_Hostel_Report_HostelStudentInformation sessionddl() 
	{
	...
	public AL_Hostel_Report_HostelStudentInformation hostelddl() 
	{
	...
	public AL_Hostel_Report_HostelStudentInformation showbutton() 
	{
	...
	public AL_Hostel_Report_HostelStudentInformation HOSTEL() 
	{
	...
	public AL_Hostel_Report_HostelStudentInformation Report() 
	{
...
//		js.executeScript("arguments[0].click;", subMenu);
	...
	public AL_Hostel_Report_HostelStudentInformation Hostel_Student_Information () 
	{
		System.out.println("Click on Hostel Student Information ");
		WebElement subMenu = driver.findElement(By.linkText("Hostel Student Information"));
//		JavascriptExecutor js = (JavascriptExecutor) driver;
//		js.executeScript("arguments[0].click;", subMenu);
		Actions action = new Actions(driver);
		action.moveToElement(subMenu).perform();
