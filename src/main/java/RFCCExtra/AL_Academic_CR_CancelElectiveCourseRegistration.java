...
public class AL_Academic_CR_CancelElectiveCourseRegistration extends BaseClass {

	public AL_Academic_CR_CancelElectiveCourseRegistration(WebDriver rdriver) {
		driver = rdriver;
	...
	public AL_Academic_CR_CancelElectiveCourseRegistration ACADEMIC() {
	...
	public AL_Academic_CR_CancelElectiveCourseRegistration CoordinatorRelated() {
	...
	public AL_Academic_CR_CancelElectiveCourseRegistration Cancelcourse() throws Exception {
	...
	public AL_Academic_CR_CancelElectiveCourseRegistration CancelStudent() {
		System.out.println("Click on Cancel Single Student Course Registration");
		click(CancelStudent);
		return this; 
	}

	public AL_Academic_CR_CancelElectiveCourseRegistration SelectSession() throws InterruptedException {
	...
	public AL_Academic_CR_CancelElectiveCourseRegistration SelectSemester() {
		...
		semesterdate.selectByVisibleText("V");
		return this;
	}

	public AL_Academic_CR_CancelElectiveCourseRegistration RRNO() {
		System.out.println("Click on RRNO button");
		RRNO.sendKeys("200011601001");
		return this;
	}

	public AL_Academic_CR_CancelElectiveCourseRegistration ShowButton() {
		System.out.println("Click on Show Button");
		click(ShowButton);
		return this;
	}

	public AL_Academic_CR_CancelElectiveCourseRegistration SelectAllChechBox() {
		System.out.println("Click on Select ChechBox");
		click(SelectAllChechBox);
		return this;
	}

	public AL_Academic_CR_CancelElectiveCourseRegistration SubmitButton() {
