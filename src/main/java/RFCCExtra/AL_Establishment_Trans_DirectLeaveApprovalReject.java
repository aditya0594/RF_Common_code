...
public class AL_Establishment_Trans_DirectLeaveApprovalReject extends BaseClass {
	ExtentReports reports;
	ExtentTest test;
	

	public AL_Establishment_Trans_DirectLeaveApprovalReject(WebDriver rdriver) {
		driver = rdriver;
...
//	private WebElement SubmitButton;
	...
	public AL_Establishment_Trans_DirectLeaveApprovalReject Establishment() {
		System.out.println("Click on ESTBALISHMENT Menu");
		Actions action = new Actions(driver);
...
//		}
	...
	public AL_Establishment_Trans_DirectLeaveApprovalReject Transaction() {
	...
	public AL_Establishment_Trans_DirectLeaveApprovalReject LeaveApproval() throws InterruptedException {
	...
	public AL_Establishment_Trans_DirectLeaveApprovalReject SelectLeave() throws InterruptedException {
	...
	public AL_Establishment_Trans_DirectLeaveApprovalReject RejectLeave() throws InterruptedException {
	...
	public AL_Establishment_Trans_DirectLeaveApprovalReject SubmitButton() throws InterruptedException {
